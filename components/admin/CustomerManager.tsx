...
export default function CustomerManager({ role, assignedBranches, forceBranchId }: Props) {
  ...
  return <AdminCustomerView role={role} assignedBranches={assignedBranches} forceBranchId={forceBranchId} />
}

// Full customer management view for SUPER_ADMIN and BRANCH_ADMIN
function AdminCustomerView({ role, assignedBranches, forceBranchId }: Props) {
